    ...
    class Base
      ...
      def parse(io, options = {})
        ...
        unless success
          ...
          if success
            raise 'Assertion failed: success was true when parsing with reporter'
          end
        ...
        if !options[:prefix] && source.chars_left > 0
          raise 'BUG: New error strategy should not reach this point.'
        end
      ...
      def apply(source, context, consume_all = false)
        ...
        success, = result = context.try_with_cache(self, source, consume_all)
