  ...
  class Pattern
    ...
    def element_match(tree, exp, bindings)
      ...
      if tree.is_a?(Hash) && exp.is_a?(Hash)
        ...
        element_match_ary_single(tree, exp, bindings)
      else
    ...
    def element_match_binding(tree, exp, bindings)
      ...
      if var_name
        bound_value = bindings[var_name]
        return bound_value == tree if bound_value
      end
    ...
    def element_match_ary_single(sequence, exp, bindings)
      ...
      sequence.zip(exp).all? do |elt, subexp|
    ...
    def element_match_hash(tree, exp, bindings)
      ...
      exp.each do |expected_key, expected_value|
        return false unless tree.key? expected_key
